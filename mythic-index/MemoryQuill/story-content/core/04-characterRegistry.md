...
```mermaid
graph TD
    %% Define Core Groups/Teams
    subgraph "Command Structure"
        Veyra("Veyra<br/>(Leader)")
        Thorne("Thorne<br/>(Second-in-Command)")
    end

    subgraph "Engineering Team"
        Korrath("Korrath<br/>(Master Engineer)")
        Cid("Cid<br/>(Apprentice)")
    end

    subgraph "Intelligence Operations"
        Marcus("Marcus<br/>(Spymaster)")
        Lyra("Lyra<br/>(Infiltrator)")
    end

    subgraph "Medical & Support"
        Aldwin("Aldwin<br/>(Healer)")
        Grimjaw("Grimjaw<br/>(Quartermaster)")
    end

    subgraph "Magical Specialists"
        Nireya("Nireya<br/>(Spirit Guide)")
    end

    subgraph "Field Operatives"
        Vera("Vera<br/>(Tracker)")
    end

    %% Command Dyad Relationships
    Veyra -.-> |"Unspoken Trust"| Thorne
    Thorne -.-> |"Absolute Loyalty"| Veyra
    
    %% Engineering Dynamics
    Korrath --> |"Mentors"| Cid
    Cid --> |"Respects Genius Of"| Korrath
    Korrath -.-> |"Argues With"| Cid
    Cid -.-> |"Challenges Methods Of"| Korrath
    Cid --> |"United Against Corruption With"| Korrath
    Korrath --> |"United Against Corruption With"| Cid
    Grimjaw --> |"Respects Craft Of"| Korrath
    Korrath --> |"Respects Craft Of"| Grimjaw

    %% Magical-Technical Collaboration
    Cid --> |"Collaborates With"| Rill
    Rill --> |"Harmonizes With"| Cid

    %% Intelligence Partnership (Updated for Lyra)
    Marcus -.-> |"Professional Rivalry With"| Lyra
    Lyra -.-> |"Competitive Respect For"| Marcus

    Lyra -.-> |"The Hunter & The Hunted"| Thorne
    Thorne -.-> |"Reluctant Handler Of"| Lyra

    %% Moral Triangle (Command & Intelligence)
    Thorne -.-> |"Disagrees on Methods With"| Marcus
    Marcus -.-> |"Views as Inflexible"| Thorne
    Veyra --> |"Mediates Between"| Thorne
    Veyra --> |"Mediates Between"| Marcus
    Veyra -.-> |"Professional Respect For"| Marcus

    %% Paternal Relationships
    Grimjaw --> |"Nurtures"| Cid
    Korrath --> |"Demands Perfection From"| Cid
    Grimjaw --> |"Mediates Between"| Korrath
    Grimjaw --> |"Warm Mentorship To"| Vera

    %% Healer Bonds
    Aldwin --> |"Counsels"| Veyra
    Veyra -.-> |"Confides In"| Aldwin
    Aldwin -.-> |"Recalibrates"| Marcus


    %% Spiritual & Physical Guardians
    Nireya -.-> |"Spiritual Guidance To"| Korrath
    Korrath -.-> |"Seeks Harmony Advice From"| Nireya

    DrMourngrave("Dr. Mourngrave<br/>(Veridian Lead)")
    DrMourngrave -.-> |"Public Hostility / Hidden Threat"| Veyra
    DrMourngrave -.-> |"Architectural Corruption (facility)"| Korrath
```
