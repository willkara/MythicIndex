...
- **appearance** — Canonical prose description containing all visual details (physical traits, attire, vibe)
- **image_inventory** — List of existing reference images with paths, descriptions, and tags
- **Previous depictions** — Use existing images to ensure consistency
...
|-------|--------|----------|
| `visual_identifiers` | `imagery.yaml` → `appearance` | `profile.md` → appearance section |
