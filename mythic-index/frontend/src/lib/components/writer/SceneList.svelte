						...
						<div class="flex-1">
							<div class="flex items-center gap-2 mb-1">
								...
								{#if scene.status === 'done'}
									<span
										class="text-xs font-medium px-2 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 rounded"
									>
										✓ Done
									</span>
								{:else}
									<span
										class="text-xs font-medium px-2 py-1 bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 rounded"
									>
										✎ Draft
									</span>
								{/if}
