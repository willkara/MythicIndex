...
- Prefer Conventional Commit-style subjects already present in history: `feat:`, `fix:`, `docs:`, `chore:`, `security:` (example: `feat(frontend): ...`, `feat(chargen): ...`).
...
- Cloudflare bindings/config live in `mythic-index/frontend/wrangler.toml`.
